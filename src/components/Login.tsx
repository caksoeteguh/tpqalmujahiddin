    ...
    <div className="flex min-h-[100dvh] items-center justify-center bg-slate-50 px-4 py-12 sm:px-6 lg:px-8 dark:bg-slate-950">
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="text-center">
          <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-emerald-400 to-teal-500 text-slate-950 shadow-xl shadow-emerald-500/20 mb-4 overflow-hidden rotate-3 hover:rotate-12 transition-transform duration-300">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-8 shadow-xl dark:border-slate-900 dark:bg-slate-900/60">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              className="flex w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-emerald-500 to-teal-500 hover:from-emerald-400 hover:to-teal-400 py-3 text-xs font-bold text-slate-950 transition-all shadow-lg shadow-emerald-500/10 active:scale-[0.98] dark:shadow-none"
            >
