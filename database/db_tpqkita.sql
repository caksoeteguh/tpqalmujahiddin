...
-- Multi-TPQ Identity & Student Evaluator
-- ==========================================
...
-- 6. Table Users (General System Accounts)
...
-- 8. Table Capaian Tahfidz (Surah/Ayah memorization logs)
CREATE TABLE IF NOT EXISTS capaian_tahfidz (
  id INT AUTO_INCREMENT PRIMARY KEY,
  santri_id VARCHAR(50) NOT NULL,
  surat_id VARCHAR(50) NOT NULL,
  ayat_range VARCHAR(100) NOT NULL, -- e.g., '1-5', 'Full Surah'
  status ENUM('Lulus', 'Mengulang') NOT NULL,
  notes TEXT,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ustadz_id VARCHAR(50) NOT NULL,
...
-- 9. Table Capaian Ibadah Praktis (Daily islamic rituals evaluation)
CREATE TABLE IF NOT EXISTS capaian_ibadah_praktis (
  id INT AUTO_INCREMENT PRIMARY KEY,
  santri_id VARCHAR(50) NOT NULL,
  category VARCHAR(100) NOT NULL, -- e.g., 'Wudhu', 'Sholat', 'Doa'
  item VARCHAR(150) NOT NULL, -- e.g., 'Gerakan Sholat', 'Doa Makan'
  status ENUM('Lulus', 'Mengulang') NOT NULL,
  notes TEXT,
  updated_at TIMESTAMP DEFAULT CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP,
  ustadz_id VARCHAR(50) NOT NULL,
...
(1, 'TPQ Al-Falah', 'Gedung Pusat Kajian Islam No. 5', '0812-9999-8888', '', 'TPQKita Digital Workspace');

INSERT INTO ustadz (id, name, username, password_hash, phone, subjects) VALUES
('U01', 'Ustadz Ahmad Fauzi, S.Pd.I', 'ahmad', '$2y$10$R9h/cIPz9fN8vG2GepW2eO0O0u79uQpZit7X3kQsh57RbeN.X283S', '08123456789', 'Jilid,Tahfidz,Ibadah Praktis');

INSERT INTO kelas (id, name, ustadz_id) VALUES
('K01', 'Kelas Al-Mulk (A)', 'U01'),
('K02', 'Kelas Ar-Rahman (B)', 'U01');
...
('S01', 'Muhammad Rizky', 'SANTRI-S01', 'Surabaya', '2015-08-12', 'K01', 'Budi Santoso', '08567890123', 'budi', '$2y$10$R9h/cIPz9fN8vG2GepW2eO0O0u79uQpZit7X3kQsh57RbeN.X283S'),
('S02', 'Aisyah Humaira', 'SANTRI-S02', 'Malang', '2016-04-20', 'K01', 'Hadi Wijaya', '08578901234', 'hadi', '$2y$10$R9h/cIPz9fN8vG2GepW2eO0O0u79uQpZit7X3kQsh57RbeN.X283S'),
('S03', 'Faris Al-Fatih', 'SANTRI-S03', 'Sidoarjo', '2015-11-30', 'K02', 'Joko Susilo', '08589012345', 'joko', '$2y$10$R9h/cIPz9fN8vG2GepW2eO0O0u79uQpZit7X3kQsh57RbeN.X283S');
...
INSERT INTO surat (id, name, total_ayat, juz) VALUES
('SR01', 'An-Nas', 6, 30),
('SR02', 'Al-Falaq', 5, 30),
('SR03', 'Al-Ikhlas', 4, 30),
('SR04', 'Al-Lahab', 5, 30),
('SR05', 'An-Nashr', 3, 30),
('SR06', 'Al-Kafirun', 6, 30);
